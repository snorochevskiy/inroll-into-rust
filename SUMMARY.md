...
* [Функции](rust-basics/funkcii.md)
...
* [Автоматическая реализация трэйтов](rust-basics/avtomaticheskaya-realizaciya-treitov.md)
* [Деструктурирующее присваивание](rust-basics/destrukturiruyushee-prisvaivanie.md)
...
## Rust проект <a href="#project" id="project"></a>
...
* [Ввод/вывод](dive-deeper-into-rust/io.md)
